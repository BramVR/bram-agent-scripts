...
- Check the Markdown output exists, is non-empty, and contains expected headings/text from the source.
- For scanned or image-heavy documents, verify OCR actually produced text before summarizing.
